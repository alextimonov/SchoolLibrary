...
<head>
    ...
    <title>School library. Protected page</title>
</head>
...
<div class="container">
    <header>
        ...
        <h3><fmt:message key="loginPage.header"/> <sec:authentication property="principal.username"/></h3>
    </header>
                ...
                <sec:authorize access="isAuthenticated()">
                    <form:form  class="form-horizontal" method="POST" action="/j_spring_security_logout">
                        <button class="btn btn-primary" type="submit">
                            <span class="glyphicon glyphicon-hand-left"></span> <fmt:message key="link.signout"/>
                        </button>
                    </form:form>
                </sec:authorize>
            </li>
    ...
    <article>
        <h4><fmt:message key="loginPage.article.p1"/></h4>
        <h4><fmt:message key="loginPage.article.p2"/></h4>
    </article>
