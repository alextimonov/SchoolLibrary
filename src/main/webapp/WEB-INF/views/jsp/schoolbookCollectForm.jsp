    ...
    <div class="container">
        <c:choose>
            <c:when test="${it.errorId == -2}">
                ...
                <form class="form-inline" action="/library/books/collectForm" method="GET">
            ...
            <c:otherwise>
                <h4>Return is successful. Class ${it.bookInClass.schoolClassCourse}-${it.bookInClass.schoolClassLetter}
                    has returned ${it.amountToCollect} books "${it.bookInClass.schoolbook.name}", now there are
