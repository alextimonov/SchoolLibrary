package ua.timonov.aplib.application;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(ua.timonov.aplib.provider.JsonMoxyContextResolver.class);
    ...
    public Map<String, Object> getProperties() {
        ...
        properties.put("jersey.config.server.provider.packages", "ua.timonov.aplib.provider");
        properties.put("jersey.config.server.provider.packages", "ua.timonov.aplib.web");
